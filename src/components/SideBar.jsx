  ...
  return (
    <div className="h-full w-full bg-black px-4 flex flex-col justify-center gap-10">
      {modalOpen && (
        ...
        >
          <div className="bg-[#262626]  rounded-lg  max-w-0-[400px] min-w-[400px] max-h-[420px] min-h-[420px] overflow-hidden text-white">
            <div
              className="w-full h-10 flex justify-center items-center bg-black rounded-t-lg"
              onClick={() => setModalOpen(false)}
            >
              <h1 style={space} className="font-bold font-sans ">
                Create new Post
              </h1>
            </div>
            {image ? (
              <img
                src={image}
                className="max-w-[400px] min-w-[400px] max-h-[420px] min-h-[420px]"
              />
            ) : (
              <div className="w-[100%] h-full flex justify-center items-center flex-col gap-3">
                <svg
                ...
                <label
                  htmlFor="file-upload"
                  className="bg-blue-500 text-white px-4 py-1 mt-4 rounded-lg hover:bg-blue-600 cursor-pointer"
                >
                ...
                <input
                  ...
                  id="file-upload"
                  type="file"
                  className="bg-blue-500 text-white px-4 py-1 mt-4 rounded-lg hover:bg-blue-600 cursor-pointer hidden"
                />
              </div>
            )}
          </div>
        ...
        <div>
          {post ? (
            <div className="max-w-52 min-w-56   max-h-24 min-h-20 absolute top-[80%] left-4 rounded-md bg-[#262626] flex flex-col justify-center gap-2">
              <div
                className="flex justify-between px-4  w-full py-2 rounded-t-md hover:bg-[#5d5c5c]"
                onClick={() => {
                  handleOpen();
                  setPost(false);
                }}
              ...
              <div className="flex justify-between px-4 py-2 hover:bg-[#5d5c5c] rounded-b-md">
                <p>Ai Characters</p>
                <svg
