...
function SideBar() {
    return (
        ...
        <div className="w-[260px] h-full  bg-black border-r-2 border-white-200 fixed px-4 flex flex-col justify-center  gap-10">
          ...
          <div className="flex flex-col gap-2 text-white">
            <h1 className="w-56 flex  justify-normal items-center gap-3 py-3  px-2  rounded-lg  hover:bg-[#262626] cursor-pointer cursor-pointer">
              {" "}
              <span>
                <svg
                  aria-label="Home"
